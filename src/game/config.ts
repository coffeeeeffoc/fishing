...
export const GAME = {
  ...
  peakSpawn: 0.5,
  finalSpawn: 0.28,
  eventTimes: [34, 64, 96, 126, 153, 168],
  eventWarning: 2,
  unlockKills: [0, 3, 8, 12],
  dropChance: 0.07,
  freezeSlow: 0.22,
  freezeHitDuration: 3,
  pufferArmor: 0.55,
  ...
  bossWeakness: 2.5,
  bossTailSlow: 0.5,
  bossSlowDuration: 3.5,
  bossDashDrain: 12,
  bossDashPeriod: 8,
  bossDashDuration: 1.25,
  bossSummonPeriod: 12,
  bulletLife: 2.2,
  coinLife: 0.8,
  shakeDecay: 18,
  ...
  waveExtra: 3,
  rushCount: 12,
  goldenEventChance: 0.6,
  treasureEventChance: 0.55,
  goldenEventCount: 5,
  treasureEventCount: 4,
  populationCaps: [24, 38, 48, 64],
  maxDpr: 2,
  minDpr: 1,
  qualityFpsThreshold: 48,
} as const;
export const BEHAVIOR = {
  pufferSpeed: 0.6,
  pufferPausePeriod: 5,
  pufferPauseDuration: 1,
  pufferPauseSpeed: 0.08,
  swordPeriod: 4,
  swordDashStart: 3.1,
  swordDashSpeed: 3.2,
  goldenAcceleration: 6,
  goldenMaxAcceleration: 1.2,
  turtleTurnAfter: 4,
  jellyPeriod: 5,
  jellyInvincibleStart: 3.7,
  exitAge: 35,
} as const;
...
export const POWERS: Record<
  PowerKind,
  { name: string; icon: string; duration: number; description: string }
> = {
  freeze: { name: '全场冻结', icon: '❄', duration: 6, description: '全场减速 6 秒' },
  bomb: { name: '深水炸弹', icon: '✹', duration: 0.65, description: '瞄准点 230 范围 / 240 伤害' },
